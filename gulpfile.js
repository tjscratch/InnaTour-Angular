...
gulp.task('build-project', function (callback) {
    runSequence('sprite', 'styles-app', ['styles', 'less', 'build-concat'], 'version-cache', 'html-replace', 'copy-project', callback);
});

gulp.task('default', function(callback){
    runSequence('sprite', 'styles-app', ['styles', 'less', 'build-templates', 'concat-comp-page-regions-lib'], 'watch',  callback);
});