...
angular.module('innaApp.directives')
    ...
    function (EventManager, $filter, $templateCache, $routeParams, $timeout, FilterPanel, FilterTime, FilterAirline, FilterAirPort, FilterAviaLegs, FilterPrice, FilterLuggageLimits) {
