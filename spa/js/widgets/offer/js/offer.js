innaAppDirectives.directive('innaOffers', function ($templateCache) {
    return {
        replace: true,
        template: function () {
            return $templateCache.get('offer.html') ? $templateCache.get('offer.html') : $templateCache.get('widgets/offer/templ/offer.html')
        },
